...
interface MobileWorkshopRegistrationCardProps {
  registration: WorkshopRegistration;
  isDark: boolean;
  isUpdating: boolean;
  onUpdateStatus: (id: string, status: WorkshopRegistrationStatus) => void;
}

export const MobileWorkshopRegistrationCard: React.FC<MobileWorkshopRegistrationCardProps> = ({
  registration,
  isDark,
  isUpdating,
  onUpdateStatus,
