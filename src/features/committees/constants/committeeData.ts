...
export const EXECUTIVE_BOARD: ExecutiveMember[] = [
  {
    ...member(
      ...
      'Chair',
      PHOTOS.male1,
      'Leading the student branch with a clear vision for excellence and community building.'
    ),
    position: 'Chair',
  },
  {
    ...member(
      ...
      'Vice Chair',
      PHOTOS.female1,
      'Supporting leadership initiatives and coordinating between all sections and committees.'
    ),
    position: 'Vice Chair',
  },
  {
    ...member(
      ...
      'Secretary',
      PHOTOS.male2,
      'Managing communications, documentation, and organizational tasks for the branch.'
    ),
    position: 'Secretary',
  },
  {
    ...member(
      ...
      'Treasurer',
      PHOTOS.male3,
      'Overseeing financial planning, budgets, and resource allocation.'
    ),
    position: 'Treasurer',
  },
  {
    ...member(
      ...
      'PR & FR Head',
      PHOTOS.female2,
      'Building connections and promoting growth through public relations and fundraising.'
    ),
    position: 'PR & FR',
  },
  {
    ...member(
      ...
      'OC Head',
      PHOTOS.male4,
      'Crafting events that bring the community together.'
    ),
    position: 'OC',
  },
];
    ...
    committees: [
      {
        ...
        slug: 'electronics',
        description:
          "Designing circuits and hardware that power tomorrow's innovations.",
        sectionName: 'Technical',
        head: member(
          'Liam O.',
          'Electronics Head',
          PHOTOS.male1,
          'A dedicated electronics engineer with extensive experience in circuit design, PCB layout, and embedded hardware. He leads the team in building innovative hardware solutions.'
        ),
        members: [
      ...
      },
      {
        ...
        head: member(
          ...
          PHOTOS.male3,
          'An embedded systems specialist with deep expertise in microcontrollers, RTOS, and firmware development. His passion lies in bridging hardware and software.'
        ),
        members: [
      ...
      },
      {
        ...
        head: member(
          ...
          'AI Head',
          PHOTOS.female2,
          'A professional AI Engineer with strong expertise in ML, DL, CV, NLP, and GenAI. She continues to drive innovation and deliver impactful AI solutions.'
        ),
        viceHead: member(
          'Salma A.',
          'AI Vice Head',
          PHOTOS.female4,
          'An AI enthusiast with hands-on experience in real projects. Recognized for strong communication skills and delivering sessions with clear explanations.'
        ),
        members: [
      ...
      },
      {
        ...
        head: member(
          ...
          'Cybersecurity Head',
          PHOTOS.male2,
          'A cybersecurity specialist focused on network security, penetration testing, and ethical hacking. He trains the next generation of security professionals.'
        ),
        members: [member('Jacob S.', 'Member', PHOTOS.male3)],
      },
      {
        name: 'Power',
        slug: 'power',
        ...
        head: member(
          ...
          'Power Head',
          PHOTOS.female3,
          'A power systems engineer with expertise in renewable energy and smart grid technologies. She leads research into next-generation power solutions.'
        ),
        members: [
          member('Emily R.', 'Member', PHOTOS.female1),
          member('Jacob S.', 'Member', PHOTOS.male4),
      ...
      },
      {
        ...
        slug: 'robotics',
        description:
          'Building intelligent machines that move, sense, and interact.',
        sectionName: 'Technical',
        head: member(
          'Youssef H.',
          'Robotics Head',
          PHOTOS.male4,
          'A robotics engineer with extensive experience in mechanical design, motion control, and computer vision for autonomous systems.'
        ),
        members: [
    ...
    committees: [
      {
        ...
        head: member(
          ...
          'Marketing Head',
          PHOTOS.male1,
          'A creative marketer with a talent for brand storytelling and digital campaigns that drive engagement.'
        ),
        members: [member('Dania F.', 'Member', PHOTOS.female4)],
      },
      {
        name: 'Multimedia',
        slug: 'multimedia',
        description:
          'Turning moments into memories through visual storytelling.',
        sectionName: 'Branding',
        head: member(
          'Doaa Gurran',
          'Multimedia Head',
          PHOTOS.female3,
          'A skilled multimedia creator with expertise in video production, photography, and graphic design.'
        ),
        members: [member('Samir T.', 'Member', PHOTOS.male2)],
      },
      {
        name: 'Podcast',
        slug: 'podcast',
        ...
        head: member(
          ...
          'Podcast Head',
          PHOTOS.female1,
          'A podcast producer passionate about creating engaging audio content that inspires and educates.'
        ),
        members: [],
      },
      {
        ...
        head: member(
          ...
          'Magazine Head',
          PHOTOS.female2,
          'An editorial lead with a keen eye for design and compelling written content.'
        ),
        members: [],
      },
    ],
    ...
    committees: [
      {
        ...
        head: member(
          ...
          'Web Dev Head',
          PHOTOS.male3,
          'A full-stack developer with deep expertise in modern web technologies, from React to Node.js.'
        ),
        members: [
      ...
      },
      {
        ...
        head: member(
          ...
          'Flutter Head',
          PHOTOS.female1,
          'A mobile development specialist building cross-platform solutions with Flutter and Dart.'
        ),
        members: [],
      },
    ],
    ...
    committees: [
      {
        ...
        head: member(
          ...
          'HR Head',
          PHOTOS.male2,
          'An HR specialist focused on team building, talent development, and organizational culture.'
        ),
        members: [member('Nada S.', 'Member', PHOTOS.female3)],
      },
      {
        name: 'PR & Fundraising',
        slug: 'pr',
        ...
        head: member(
          ...
          'PR Head',
          PHOTOS.male4,
          'A public relations professional skilled in partnership building and sponsor acquisition.'
        ),
        members: [member('Kareem L.', 'Member', PHOTOS.male1)],
      },
      {
        ...
        head: member(
          ...
          'EC Head',
          PHOTOS.female2,
          'An event coordination expert with experience planning and executing large-scale technical events.'
        ),
        members: [
