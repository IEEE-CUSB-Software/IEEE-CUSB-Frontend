...
const NewsCard = ({
  ...
  <SectionReveal delay={delay}>
    <div className="bg-card rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300">
...
export const LatestNewsSection = () => {
  const newsItems = [
    ...
    },
    {
      ...
      description:
        'Congratulations to our talented members for their award-winning projects.',
        ...
        <div className="flex justify-between items-center mb-12">
          <div>
            ...
            <p className="text-muted-foreground">
              Updates from our chapters and student activities
            </p>
          </div>
          <a href="#" className="text-primary font-semibold hover:underline">
            View Archive →
