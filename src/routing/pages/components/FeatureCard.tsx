...
export const FeatureCard = ({
                ...
                <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="none">
                    <defs>
                        <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
                            <stop offset="0%" style={{ stopColor: '#00629B', stopOpacity: 1 }} />
                            <stop offset="50%" style={{ stopColor: '#0082C8', stopOpacity: 1 }} />
                ...
                <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="none">
                    <defs>
                        <linearGradient id="grad2" x1="100%" y1="0%" x2="0%" y2="100%">
                            <stop offset="0%" style={{ stopColor: '#0082C8', stopOpacity: 1 }} />
                            <stop offset="50%" style={{ stopColor: '#00629B', stopOpacity: 1 }} />
                            <stop offset="100%" style={{ stopColor: '#004A7C', stopOpacity: 1 }} />
                        </linearGradient>
                    </defs>
                    <path
                ...
                <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="none">
                    <defs>
                        <linearGradient id="grad3" x1="0%" y1="100%" x2="100%" y2="0%">
                            <stop offset="0%" style={{ stopColor: '#003D5C', stopOpacity: 1 }} />
                            <stop offset="50%" style={{ stopColor: '#00629B', stopOpacity: 1 }} />
                            <stop offset="100%" style={{ stopColor: '#0090D0', stopOpacity: 1 }} />
                        </linearGradient>
                    </defs>
                    <path
    ...
    return (
        <motion.div
            ...
            transition={{ duration: 0.8, delay: delay + 1.2, ease: [0.4, 0.0, 0.2, 1] }}
